...
export const demoTemplates: Record<IndustryId, DemoTemplate> = {
  roofing: {
    ...
    beforeAfter: [
      ...
      { before: "Reps ask the same claim and property questions manually.", after: "Envo captures claim context before handoff." }
    ],
    packageBias: "Growth"
  },
  hvac: {
  ...
  electrical: {
    ...
    beforeAfter: [
      ...
      { before: "Install quotes lack scope before callback.", after: "Envo captures project type, property, and timing." }
    ],
    packageBias: "Growth"
  },
  "med-spa": {
  ...
  "law-firm": {
    ...
    beforeAfter: [
      ...
      { before: "Automation risks sounding like legal advice.", after: "Envo keeps replies practical and routes legal judgment to humans." }
    ],
    packageBias: "Custom"
  },
  "insurance-agency": {
  ...
  "general-local-service": {
    ...
    beforeAfter: [
      { before: "Leads are scattered across forms, calls, and inboxes.", after: "Envo captures and routes each inquiry with the right next step." },
