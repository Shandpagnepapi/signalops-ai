...
export const SEO_LANDING_PAGES: Record<SeoLandingPageId, SeoLandingPageConfig> = {
  "ai-lead-response": {
    ...
    metaTitle: "AI Lead Response System for Small Businesses",
    metaDescription:
      "LeadOps installs AI-assisted lead response systems that answer new calls, texts, forms, DMs, and quote requests quickly with practical next steps.",
    h1: "AI lead response that answers new inquiries before they go cold.",
    subheadline:
      "LeadOps helps small and mid-sized businesses respond to every new lead quickly, collect the right details, and route the next step without adding more admin work.",
    heroBullets: [
    ...
    solutionTitle: "How LeadOps solves lead response",
    solutionIntro:
      "LeadOps maps your current intake process, writes practical response logic, and connects the workflow to the channels your business already uses.",
    solutionCards: [
      {
    ...
    workflow: [
      ...
      },
      {
        ...
        description:
          "LeadOps confirms the request, asks for missing details, and explains what happens next."
      },
      {
        label: "3",
    ...
    faqs: [
      {
        ...
        answer:
          "No. LeadOps focuses on the response process behind your calls, texts, forms, DMs, and quote requests. A chat widget can be one channel, but the real value is making sure every inquiry gets a clear next step."
      },
      {
        question: "Can it work if most of our leads come from phone calls?",
        answer:
          "Yes. Missed-call text back and call follow-up workflows are a strong use case. LeadOps can start with calls and texts before adding CRM or website integrations."
      },
      {
        question: "What happens if the lead is urgent or complicated?",
        answer:
          "The system should flag it for human review and alert the right person. LeadOps is designed to escalate uncertainty instead of pretending every question can be fully automated."
      },
      {
    ...
    relatedLinks: [
      ...
      {
        href: "/how-it-works",
        label: "How the LeadOps engine works",
  ...
  "missed-call-text-back": {
    ...
    metaTitle: "Missed-Call Text Back for Local Service Businesses",
    metaDescription:
      "Turn missed calls into captured leads with text-back workflows that collect service need, urgency, contact details, and booking intent.",
    h1: "Missed-call text back that keeps phone leads from disappearing.",
    subheadline:
      "LeadOps helps busy service teams automatically respond to missed calls, gather the reason for the call, and alert the right person when the opportunity needs attention.",
    heroBullets: [
    ...
    solutionTitle: "How LeadOps handles missed calls",
    solutionIntro:
      "LeadOps creates a text-back workflow that feels like a helpful front desk, then routes replies into a simple lead process.",
    solutionCards: [
      {
    ...
    workflow: [
      ...
      },
      {
        ...
        description:
          "LeadOps routes the lead with a summary, score, urgency, and suggested next action."
      }
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. LeadOps can start with simple call/text capture, owner alerts, and a lightweight dashboard. A CRM can be added later if the business needs it."
      },
      {
    ...
    relatedLinks: [
      {
        ...
        description: "See how LeadOps answers all lead sources, not just missed calls."
      },
      {
  ...
  "ai-follow-up-automation": {
    ...
    metaTitle: "AI Follow-Up Automation for Service Business Leads",
    metaDescription:
      "LeadOps builds practical AI-assisted follow-up sequences for quote requests, missed calls, photo requests, estimates, and appointment reminders.",
    h1: "AI follow-up automation for leads that are interested but not booked yet.",
    subheadline:
      "LeadOps keeps prospects from slipping away after the first reply by sending useful reminders, asking for missing details, and alerting your team when a lead is ready for action.",
    heroBullets: [
    ...
    solutionTitle: "How LeadOps builds follow-up automation",
    solutionIntro:
      "LeadOps creates follow-up paths based on lead status, missing details, urgency, service type, and whether the customer has booked.",
    solutionCards: [
      {
    ...
    workflow: [
      ...
      },
      {
        ...
        description:
          "LeadOps requests the specific information needed to move the quote forward."
      },
      {
        label: "3",
      ...
      },
      {
        ...
        description:
          "When the customer replies with intent, LeadOps sends the context to the right person."
      }
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "It depends on the service and the customer's intent. LeadOps usually recommends a few useful touches with clear stop conditions, not endless automated chasing."
      },
      {
      ...
      },
      {
        ...
        answer:
          "The workflow should stop or move the lead to a long-term nurture path. LeadOps is designed to respect customer intent."
      },
      {
  ...
  "ai-lead-qualification": {
    ...
    metaTitle: "AI Lead Qualification for Small and Local Businesses",
    metaDescription:
      "LeadOps scores, summarizes, tags, and routes inbound leads by urgency, fit, service need, buying intent, and contact completeness.",
    h1: "AI lead qualification that helps your team know who to call first.",
    subheadline:
      "LeadOps turns messy lead submissions into clear summaries, priority scores, tags, and recommended next actions so your team can focus on the best opportunities.",
    heroBullets: [
    ...
    solutionTitle: "How LeadOps qualifies leads",
    solutionIntro:
      "LeadOps creates scoring rules and AI prompts around your actual business, services, service area, team capacity, and risk boundaries.",
    solutionCards: [
      {
        title: "Lead scoring",
        description:
    ...
    workflow: [
      ...
      {
        label: "2",
        title: "LeadOps extracts signals",
        description:
    ...
    faqs: [
      {
        ...
        answer:
          "It can help prioritize, but it should not be the only decision-maker. LeadOps recommends human review for unclear, risky, or high-value cases."
      },
      {
    ...
    relatedLinks: [
      ...
      },
      {
        ...
        description: "See how qualified leads appear inside a LeadOps dashboard."
      }
    ]
  },
  "lead-management-for-small-business": {
    ...
    metaTitle: "Lead Management for Small Businesses Without Extra Admin",
    metaDescription:
      "LeadOps gives small businesses a simple lead management layer for calls, texts, forms, DMs, follow-up status, owner alerts, and reporting.",
    h1: "Lead management for small businesses that do not need more admin work.",
    subheadline:
      "LeadOps helps owners and lean teams organize new inquiries, follow-ups, statuses, and sales handoffs without forcing a complicated CRM rollout on day one.",
    heroBullets: [
    ...
    whyCards: [
      ...
      },
      {
        ...
        description:
          "A complex system only works if the team uses it. LeadOps can start with the simplest useful workflow."
      }
    ],
    solutionTitle: "How LeadOps manages leads",
    solutionIntro:
      "LeadOps gives your business a clear lead flow: capture, qualify, route, follow up, and track status.",
    solutionCards: [
      {
    ...
    workflow: [
      {
        ...
        description:
          "A call, text, form, DM, or quote request enters the LeadOps workflow."
      },
      {
        label: "2",
    ...
    faqs: [
      {
        question: "Is LeadOps a CRM?",
        answer:
          "LeadOps can connect to a CRM, but it is not limited to being one. It is a lead operations layer focused on response, qualification, follow-up, routing, and visibility."
      },
      {
        question: "Can we use LeadOps before choosing a CRM?",
        answer:
      ...
      },
      {
        ...
        answer:
          "LeadOps can start there. Calls, texts, missed-call replies, and simple dashboards are often enough for the first version."
      },
      {
  ...
  "no-crm-lead-tracking": {
    ...
    metaTitle: "No-CRM Lead Tracking for Calls, Texts, Forms, and DMs",
    metaDescription:
      "LeadOps helps small businesses track leads without a CRM by organizing calls, texts, forms, DMs, follow-ups, owner alerts, and simple pipeline status.",
    h1: "No-CRM lead tracking for businesses that run through calls and texts.",
    subheadline:
      "LeadOps helps small teams capture every request, separate urgent leads from routine ones, and keep follow-ups visible even if they are not ready for a formal CRM.",
    heroBullets: [
    ...
    plainEnglishBody:
      "A lot of small businesses are not ready for a full CRM. That does not mean they should keep losing leads in phone logs, texts, and DMs. No-CRM lead tracking means LeadOps creates a simple system around your current workflow: capture the inquiry, collect the right details, apply a status, remind the team, and keep the next step visible.",
    ...
    solutionTitle: "How LeadOps tracks leads without a CRM",
    solutionIntro:
      "LeadOps can build the first version around calls, texts, forms, DMs, alerts, and a lightweight dashboard.",
    solutionCards: [
      {
      ...
      },
      {
        ...
        description:
          "Once the flow works, LeadOps can connect the same structure into a CRM, calendar, or sales tool."
      }
    ],
    ...
    workflow: [
      ...
      {
        label: "2",
        title: "LeadOps asks for context",
        description:
    ...
    faqs: [
      {
        question: "Can LeadOps really work without a CRM?",
        answer:
          "Yes. LeadOps can start with forms, calls, texts, alerts, and a lightweight lead store. A CRM can be added later if it becomes useful."
      },
      {
        question: "Will I still own my lead data?",
        answer:
          "The system should be set up so leads can be exported or moved into future tools. LeadOps is meant to create structure, not trap your business."
      },
      {
    ...
    relatedLinks: [
      {
        href: "/lead-management-for-small-business",
        label: "Small business lead management",
        description: "See the broader lead management system LeadOps can install."
      },
      {
        href: "/missed-call-text-back",
        label: "Missed-call text back",
