...
export function scoreLead(lead: LeadSubmissionDraft): LeadScoringResult {
  ...
  const customerReply = (() => {
    ...
    if (auditLead) {
      return `Thanks ${name}, SignalOps received your Free Missed Lead Checkup request. We'll review how your business handles calls, texts, forms, DMs, and follow-ups, then show where leads are getting missed, delayed, or forgotten.`;
    }
