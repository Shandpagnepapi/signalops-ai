  ...
  return (
    <div className="overflow-x-hidden">
      <section className="relative isolate overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_8%,rgba(47,124,255,0.28),transparent_34%),radial-gradient(circle_at_78%_18%,rgba(23,200,242,0.18),transparent_30%),linear-gradient(180deg,#081326,#060c18_88%)]" />
      ...
      <section className="border-b border-white/10 bg-[linear-gradient(180deg,#07101f,#060c18)]">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
