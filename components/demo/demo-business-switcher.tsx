...
export function DemoBusinessSwitcher() {
  ...
  return (
    <div className="bg-[#080a0f]">
      <section className="sticky top-[61px] z-40 border-b border-white/10 bg-slate-950/95 px-4 py-3 backdrop-blur-xl sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <Badge className="bg-sky-400/15 text-sky-100">LeadOps client demo</Badge>
